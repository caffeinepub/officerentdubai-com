...
export class Backend implements backendInterface {
    ...
    async getLocationSuggestions(arg0: string, arg1: bigint | null): Promise<Array<LocationSuggestion>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLocationSuggestions(arg0, to_candid_opt_n30(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPropertiesByArea(arg0: string): Promise<Array<Property>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPropertiesByArea(arg0);
                return from_candid_vec_n18(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchPropertiesByLocation(arg0: string): Promise<Array<Property>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchPropertiesByLocation(arg0);
                return from_candid_vec_n18(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
