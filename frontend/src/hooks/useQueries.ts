...
import type { Property, PropertyType, FurnishingStatus, UserProfile, UserRole, CreatePropertyParams, LocationSuggestion } from '../backend';
...
/**
 * Helper function to extract area name from location string.
 * Expected format: "Building Name, Area Name"
 */
 ...
 * Fetches location suggestions with area information from stored properties.
 */
  ...
  return useMutation({
    mutationFn: async (data: {
      ...
      const params: CreatePropertyParams = {
        ...
        areaName: extractAreaName(data.location),
